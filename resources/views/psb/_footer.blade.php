<footer class="short" id="footer">
	...
	<div class="footer-copyright">
		<div class="container">
			<div class="row">
				<div class="col-md-2"><a href="/" class="logo"><img alt="Sekolah Kasih Maitreya" class="img-responsive" src="http://cdn.skm-meranti.sch.id/images/skm-logo-white.png"></a></div>
				<div class="col-md-8"><p>&copy; Copyright 2015. All Rights Reserved.</p></div>
			</div>
		</div>
	</div>
</footer>